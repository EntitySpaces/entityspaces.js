...
(function (es) { //myNS = "myNameSpace" ... for example purposes
	...
	es.objects.Staff.prototype.routes = {
		commit: { method: 'PUT', url: 'Staff_Save', response: 'entity' },
		loadByPrimaryKey: { method: 'GET', url: 'Staff_LoadByPrimaryKey', response: 'entity', synchronous: true }
	};
...
(function (es) {
	...
	es.objects.StaffCollection.prototype.routes = {
		commit: { method: 'PUT', url: 'StaffCollection_Save', response: 'collection' },
		loadAll: { method: 'GET', url: 'StaffCollection_LoadAll', response: 'collection', synchronous: true }
	};
